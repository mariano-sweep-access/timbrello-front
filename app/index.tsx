...
export default function Index() {
  return (
    <SafeAreaView className="bg-white/50 flex-1">
      <FlatList
        data={[
          { id: "1", title: "Cacique Cumbay 715", image: constants.houseOne },
          { id: "2", title: "Av. Directorio 3457", image: constants.houseTwo },
          { id: "3", title: "San Nicolas 1435", image: constants.houseThree },
          { id: "4", title: "Holmberg 2410", image: constants.houseFour }
        ]}
        renderItem={({ item }) => (
